...
export class SearchMockApi
{
    ...
    ngOnInit(): void {
        ...
        // this. _service.signIn().subscribe((data) => {
    ...
    registerHandlers(): void
    {
        ...
        let flatNavigation = null;
        
       // let AdminNavigation=this._fuseNavigationService.GetAdminNavigation(this._AdminNavigation)
       
        this.loginuser = window.localStorage.getItem('role');
        //this.loginuser = user;
